    ...
    try:
        ...
        if user_state.get(sender_number) == 'awaiting_otp':
            if incoming_msg == admin_otp:
                ...
                user_state[sender_number] = 'admin_departments'
            else:
        ...
        # قائمة الإدارات (بعد الدخول بنجاح)
        if user_state.get(sender_number) == 'admin_departments':
            if incoming_msg == '1':
                ...
                msg.body("❓ يرجى اختيار رقم صحيح من القائمة.")
            return str(response)
